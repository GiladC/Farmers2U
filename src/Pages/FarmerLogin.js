...
const Auth = () => {
  ...
  return (
    <div dir="rtl">
        <form autoComplete="off" onSubmit={handleSubmit}>
            <Box bgcolor="beige" sx={{":hover": {bgcolor: '#ffeecc', color: "black", boxShadow: "5px 5px 10px #ccc"}
      }} boxShadow={2}  border={1} display="flex" flexDirection={"column"} maxWidth={700} maxHeight={2000} alignItems={"center"} justifyContent={"center"} margin={"auto"} mt={4} padding={10}  >
                ...
                <Button onClick={() => {navigate("/form");}} variant='text' size='medium' sx={{ mt: 4, borderRadius: 4}} color='inherit'> מעבר לטופס הרשמה </Button>         
            </Box>
        </form>
    </div>
  )
