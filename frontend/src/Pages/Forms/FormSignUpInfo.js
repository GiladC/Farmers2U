  ...
  return (
        ...
        <form autoComplete="off">
          ...
          <Box marginTop={5} bgcolor="#f7f1e5" boxShadow={0} borderRadius={2} border={2} display="flex" flexDirection={"column"} width={580} height={164.7} alignItems={"center"} justifyContent={"center"} mt={3.2} mr={2.3} padding={20} sx={{border: '1.5px solid #f7f1e5'}}  >
              ...
              <Typography color="#37474f" fontFamily="aleph" fontWeight={'bold'} mt={2} fontSize={22}  mr={-1} marginBottom={8} marginTop={3} variant='h2'  textAlign={"center"}> שלב 1 - פרטים אישיים</Typography>
              </Box>
            <Grid container style={{paddingRight: '30px', paddingLeft: '10px'}}>
            <form>
                <Box sx={{marginLeft:"73%"}}>
                  <div
                    id="signUpDiv"
            ...
            <a href='/login'>
              <Button /*onClick={() => { <FormLogin></FormLogin> }}*/ variant='text' size='medium' sx={{fontFamily:"aleph", ml:2, mt: 4, borderRadius: 4, fontSize: 16}} color='inherit'> משתמש קיים? לחץ כאן</Button>  
            </a>
          </Box>  
        </form>
  );
